        ...
        <>
            <div className={`py-2 ${themeColor == "light" ? "bg-green-600" : "bg-slate-900"} justify-between items-center px-16 shadow-2xl hidden lg:xl:flex w-full`}>
                ...
                <div className=' text-white'>
                    ...
                    <NavLink to={"/projects"} className="p-3 text-xl font-bold duration-500 hover:rotate-3 hover:text-lime-800 " style={ActiveLink}>Projects & Works</NavLink>
            ...
            <div className='py-2 bg-green-600 flex justify-between items-center p-8 md:lg:xl:px-16 md:lg:xl:hidden w-full'>
                ...
                <div className=' text-white hidden md:lg:xl:flex'>
                    ...
                    <NavLink to={"/projects"} className="p-3">Projects & Works</NavLink>
            ...
            <div className={`bg-green-700 flex justify-center items-center md:lg:xl:px-16 md:lg:xl:hidden ${Menu ? "hidden" : ""}`}>
                <div className='flex text-white text-3xl'>
                    ...
                    <NavLink to={"/projects"} className="p-3"><AiOutlineFundProjectionScreen className='text-white' /></NavLink>
