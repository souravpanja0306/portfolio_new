            ...
            style={{ backgroundImage: `url("/assets/sourav33.jpg")`}}>
                ...
                <div className='w-full md:lg:xl:w-2/3 justify-center md:lg:xl:p-12 py-2'>
                    <div className='text-white text-center md:lg:xl:text-left'>
                        <h1 className='text-orange-500 font-bold text-4xl md:lg:xl:text-6xl pt-4'>Hi, there!</h1>
                        <h1 className='text-green-500 font-bold text-3xl md:lg:xl:text-5xl pt-4'>This is <span className='text-5xl md:lg:xl:text-7xl text-orange-500'>Sourav Panja </span> here.....</h1>
                        <h1 className='text-slate-400 font-bold text-2xl pt-4'>MERN Stack Developer - MongoDB || ExpressJs || ReactJs || NodeJS </h1>
                    </div>
