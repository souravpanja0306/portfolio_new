            ...
            <div className="flex-cols md:lg:xl:flex">
                ...
                <div className='w-full md:lg:xl:w-2/3 justify-center md:lg:xl:p-12 py-2'>
                    <div className='text-white text-center md:lg:xl:text-left'>
                        <h1 className='text-orange-500 font-bold text-2xl md:lg:xl:text-4xl pt-4'>Hello! It's Me</h1>
                        ...
                        <h1 className='text-slate-400 font-bold text-3xl pt-4'>And I am MERN Stack Developer.</h1>
                        <h1 className='text-slate-400 font-bold text-md'>MongoDB || ExpressJs || ReactJs || NodeJS </h1>
                    </div>
                    <div className='flex justify-center md:lg:xl:p-6 py-2'>
                        <a href="https://www.instagram.com/panja0306/" target="blank">
                            <AiFillInstagram className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-pink-800 shadow-xl rounded-full' />
                        </a>
                        <a href="https://www.facebook.com/souravpanja03" target="blank">
                            <AiOutlineFacebook className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-blue-600 shadow-xl rounded-full' />
                        </a>
                        <a href="https://github.com/souravpanja0306" target="blank">
                            <AiFillGithub className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-slate-500 shadow-xl rounded-full' />
                        </a>
                        <a href="https://www.linkedin.com/in/sourav-panja-452b33205/" target="blank">
                            <AiFillLinkedin className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-blue-700 shadow-xl rounded-full' />
                        </a>
                        <a href="https://wa.me/7278159888" target="blank">
                            <AiOutlineWhatsApp className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-green-500 shadow-xl rounded-full' />
                        </a>
                        <a href="https://twitter.com/souravpanja9" target="blank">
                            <AiFillTwitterCircle className='md:lg:xl:m-4 text-5xl md:lg:xl:text-6xl hover:rotate-90 duration-500 text-blue-600 shadow-xl rounded-full' />
                        </a>
                    </div>
