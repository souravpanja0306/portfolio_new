  ...
  return (
    <Layout>
      <div className='md:lg:xl:flex'>
        <div className={`w-full md:lg:xl:max-w-1/2 rounded-lg shadow-lg p-6 md:lg:xl:py-12 md:lg:xl:px-24 ${themeColor === "dark" ? "bg-slate-600" : "bg-slate-100"} border-solid border-slate-300 border-2 md:lg:xl:m-6 my-2`}>
